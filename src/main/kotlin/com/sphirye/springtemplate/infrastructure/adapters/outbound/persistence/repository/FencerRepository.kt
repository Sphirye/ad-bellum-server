...
import com.sphirye.springtemplate.infrastructure.adapters.outbound.persistence.entity.Fencer
import com.sphirye.springtemplate.infrastructure.adapters.outbound.persistence.entity.FencerStats
...
interface FencerRepository : JpaRepository<Fencer, Long> {
    ...
    fun findAllByNameIgnoreCaseContaining(name: String, pageable: Pageable): Page<Fencer>
